...
Public Class Frmmatcalle

    Private Sub Frmmatcalle_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        CatControl1.filtrar("select id_matcalle as Clave, descripcion as Descripción from mat_calle")
    End Sub

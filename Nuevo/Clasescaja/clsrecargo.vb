Public Class Clsrecargo
    ...
    Public valorderecargo As Double = 3 'My.Settings.Porcentajederecargo
    ...
    Public Sub calcular(ByVal consumo As Collection, ByVal tipo As String)
        ...
        For i = consumo.Count To 1 Step -1
            ...
            '    mesestranscurridos = DateDiff(DateInterval.Month, fecha, Now)  ' -1 si se desea que el mes pasado no paga recargos 

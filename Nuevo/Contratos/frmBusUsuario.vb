...
#End Region
    ...
    Private Sub cmdFiltro_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdFiltro.Click
        ...
        Else
            ...
            filtro("select distinct cuenta as Cuenta, nombre as Nombre , domicilio as Direccion,comunidad as Comunidad,estado as Estado,nodemedidor as Medidor,catastral  from vusuario order by cuenta")

...
Public Class frmrepaltaconsumidor
    Dim filtro As String
    Public quees As String = "Listado de altos consumidores"
    ...
    Public Sub Reporteusuarioalto(ByVal sql As String, ByVal caso As String)
        Try
            ...
            Dim directorioReporte As String = (Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "altoconsumidor\").Trim
            ...
            Dim pdfWrite As PdfWriter = PdfWriter.GetInstance(pdfDoc, New System.IO.FileStream(directorioReporte & "\altoconsumidor_" & Fecha & "_" & nuevaLetra & ".pdf", FileMode.Create))
            ...
            Process.Start(directorioReporte & "\altoconsumidor_" & Fecha & "_" & nuevaLetra & ".pdf")
    ...
    Private Sub frmrepaltaconsumidor_Load(sender As Object, e As EventArgs) Handles MyBase.Load

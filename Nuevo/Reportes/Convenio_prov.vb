...
Public Class Convenio_prov
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AcquaLiberVista.Convenio_prov.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConvenio_prov
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Convenio_prov = New Convenio_prov
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class RelacionRecaudacion
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RelacionRecaudacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AcquaLiberVista.RelacionRecaudacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRelacionRecaudacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RelacionRecaudacion = New RelacionRecaudacion
        rpt.Site = Me.Site
        Return rpt
    End Function

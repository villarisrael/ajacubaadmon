...
Public Class RprSituaciones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AcquaLiberVista.RprSituaciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRprSituaciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RprSituaciones = New RprSituaciones
        rpt.Site = Me.Site
        Return rpt
    End Function

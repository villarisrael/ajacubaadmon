...
Public Class RptBajaTemporal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AcquaLiberVista.RptBajaTemporal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptBajaTemporal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptBajaTemporal = New RptBajaTemporal
        rpt.Site = Me.Site
        Return rpt
    End Function

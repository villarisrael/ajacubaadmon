...
Public Class catConceptoscxc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AcquaLiberVista.catConceptoscxc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcatConceptoscxc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As catConceptoscxc = New catConceptoscxc
        rpt.Site = Me.Site
        Return rpt
    End Function

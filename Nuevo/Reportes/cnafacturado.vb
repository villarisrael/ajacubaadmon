...
Public Class cnafacturado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AcquaLiberVista.cnafacturado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcnafacturado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cnafacturado = New cnafacturado
        rpt.Site = Me.Site
        Return rpt
    End Function

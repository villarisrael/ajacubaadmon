...
Public Class rptCompAdeudo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AcquaLiberVista.rptCompAdeudo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCompAdeudo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCompAdeudo = New rptCompAdeudo
        rpt.Site = Me.Site
        Return rpt
    End Function

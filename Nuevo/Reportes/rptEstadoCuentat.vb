...
Public Class rptEstadoCuentat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AcquaLiberVista.rptEstadoCuentat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEstadoCuentat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEstadoCuentat = New rptEstadoCuentat()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class ContratoAlcantarillado

    Public Sub GenerarContratoAlcantarillado(cuentaP As Double, formatoP As String, OBSERVACION As String)
        ...
        Try
            ...
            Dim Col1Titulo = New PdfPCell(New Phrase("CONTRATO DE PRESTACIÓN DE SERVICIOS DE ALCANTARILLADO", Font12))
            Col1Titulo.Border = 0
...
El (la) C." & datosUsuario("Nombre") & " con domicilio para oír y recibir notificaciones " & datosUsuario("DOMICILiO") & "," & datosUsuario("COMUNIDAD") & ", MUNICIPIO DE MULEGÉ, BAJA CALIFORNIA SUR. ", Font12))
            ...
            Dim Col1CuerpoContrato2 = New PdfPCell(New Phrase($"Solicita atentamente el servicio de la conexión a la red de alcantarillado dé este Sistema de Agua Potable y Alcantarillado, en el domicilio citado al inicio de esta solicitud. 
...
", Font12))
            ...
            Dim Col1CuerpoContrato3 = New PdfPCell(New Phrase($"Por lo anterior, manifiesto mi conformidad con lo siguiente:
...
", Font88))
            ...
            Dim Col1CuerpoContrato4 = New PdfPCell(New Phrase($"a).- En pagar la cuota por derecho de conexión aprobado por la Junta de Gobierno del Sistema de Agua Potable,  Alcantarillado y Saneamiento, con el objeto de que dicho establecimiento quede conectado a la red de alcantarillado. Esta cuota por concepto de derechos de tubería de salida será pagadera al contado.

b).- Por ultimo manifiesto mi conformidad en pagar  las cuotas que establezcan las  tarifas  que  autorice  la Junta de Gobierno, para la  amortización, operación, conservación y administración del sistema.
...
", Font12))
            ...
            Col1CuerpoContrato4.Border = 0
            Col1CuerpoContrato4.HorizontalAlignment = PdfPCell.ALIGN_JUSTIFIED
            TableCuerpoContrato.AddCell(Col1CuerpoContrato4)

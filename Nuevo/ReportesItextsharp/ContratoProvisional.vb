...
Public Class ContratoProvisional
    ...
    Public Sub GenerarContratoAgua(cuentaP As Double, formatoP As String, OBSERVACION As String)
        ...
        Try
            ...
            Dim Col1CuerpoContrato = New PdfPCell(New Phrase("Contrato Provisional de prestación de servicios de agua que celebran por una parte el Sistema de Agua Potable, Alcantarillado y Saneamiento de MULEGÉ, Baja California Sur, representado por el C " & Director & " en su carácter de Administrador, a quién en lo sucesivo se le denominará "" EL SISTEMA "", y por otra parte el C.  " & datosUsuario("nombre") & " Quien en el cuerpo del presente se le denominará "" EL USUARIO ”", sometiéndose al tenor de las siguientes cláusulas:", Font12))
...
PRIMERA: El presente contrato de servicio de agua potable se considerará provisional y estará sujeto a la acreditación de la propiedad por parte del Usuario. En caso de que una persona debidamente autorizada se presente y acredite la propiedad del inmueble objeto del presente contrato, este se considerará nulo y sin validez a partir de la fecha de acreditación de la propiedad. El Usuario se compromete a notificar a la Compañía de Agua Potable de inmediato en caso de cualquier cambio en la propiedad del inmueble. El servicio será conectado en  {datosUsuario("Domicilio")} {datosUsuario("Comunidad")}, MPIO. de Mulegé, BCS.

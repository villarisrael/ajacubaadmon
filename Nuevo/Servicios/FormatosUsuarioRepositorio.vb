    ...
    Public Function GenerarContratoAguaPDF(objetoModelo As UsuarioDTO) As Boolean Implements IFormatos(Of UsuarioDTO).GenerarContratoAguaPDF
        ...
        Using ms As New MemoryStream()
            ...
            Try
                ...
                encabezadoTable.SetWidths(New Single() {20, 60, 20})
                ...
                Dim Col1Titulo = New PdfPCell(New Phrase("CONTRATO DE SERVICIO DE AGUA POTABLE", Font10Bold))
                Col1Titulo.Border = 0
...
I. Que, lleva por nombre {objetoModelo.Nombre}, con domicilio {objetoModelo.Domicilio}, COL. {objetoModelo.Colonia}, {objetoModelo.Comunidad}, {CPoblacion}, {Estadoempresa}, CODIGO POSTAL {objetoModelo.Cp}.
...
", Font10))
                ...
                Col1CuerpoContrato2 = New PdfPCell(New Phrase($"
...
VIGÉSIMA NOVENA. - SUSPENSIÓN DE LOS SERVICIOS- {“LAS PARTES”} convienen, en que la falta de pago en dos ocasiones consecutivas por parte de {“EL USUARIO”} faculta a{“CAYSA”} a suspender los servicios públicos objeto de este contrato, hasta que regularice su pago. De no regularizarse {“EL USUARIO”} en el término de 30 treintadías naturales, se procederá a la suspensión desde las redes de distribución. Igualmente procederá la suspensión de los servicios, cuando se detecten derivaciones n autorizadas, uso distinto al contratado, se reinstale el servicio violando sellos, o se proporcione servicio de otra toma de agua a las tomas que se encuentrensuspendidas; así como cuando {“EL USUARIO”} no haya presentado la documentación requerida en los términos que {“CAYSA”} señale.

Lo anterior, sin perjuicio de proceder a fijar las multas que procedan.

{“LAS PARTES”} convienen en que únicamente se podrá considerar regularizada la situación en caso de que se pague el importe total adeudado, o bien se suscriba unconvenio de pago en parcialidades, conforme a los lineamientos que para tal efecto establezca {“CAYSA”}. En este último supuesto, {“LAS PARTES”} están de acuerdo enque el atraso en el pago de 1 (una) o más parcialidades, da derecho a {“CAYSA”} a suspender los servicios inmediatamente. 

{“CAYSA”}, podrá en todo caso, tomar libremente la decisión de suspender cualquiera de los servicios no pagados, o todos ellos a la vez, atendiendo a lasparticularidades del caso. 

Cuando se determine suspender uno a uno los servicios no pagados, se preferirá iniciar con la suspensión del de suministro de agua; y al final con la suspensión delservicio de alcantarillado.

Durante el tiempo que estén suspendidos los servicios, cuando dicha suspensión sea por causa imputable a {“EL USUARIO”}, {“CAYSA”} podrá continuar emitiendo losrecibos y/o informativos de pago correspondientes, considerando la cuota mínima vigente, obligándose {“EL USUARIO”} a pagarlos.

TRIGÉSIMA. - RECONEXIÓN- El costo por la reconexión de los servicios que se hubieran suspendido, correrá por cuenta de {“EL USUARIO”}, quién acepta que dicho costo secobrara de conformidad con el tipo de corte que se haya realizado y con las tarifas autorizadas para tal efecto. 

TRIGÉSIMA PRIMERA. - INSPECCIONES Y VERIFICACIONES- {“LAS PARTES”} convienen en que {“CAYSA”}, podrá llevar a cabo en todo tiempo y sin previo aviso, las inspeccionesy verificaciones que resulten procedentes en los términos de la Ley Estatal de Agua y Alcantarillado y su Reglamento; quedando obligado {“EL USUARIO”} a brindartodas las facilidades requeridas para que lleven a cabo tales actos. Lo anteriormente expuesto debe de entenderse sin perjuicio de las facultades con que cuentenotras dependencias de la Administración Pública Federal, Estatal o Municipal. 

TRIGÉSIMA SEGUNDA. - {“EL USUARIO”} autoriza expresamente a {“CAYSA”} para que cualquier adeudo que resulte de las obligaciones derivadas de este contrato, seancargadas al o los recibos y/o informativos ordinarios de pago.

TRIGÉSIMA TERCERA. - SUPLETORIEDAD- En todo lo no previsto en el presente contrato, {“LAS PARTES”} se someten a lo establecido en la Ley Estatal de Agua yAlcantarillado y su Reglamento.

TRIGÉSIMA CUARTA. - MEDIOS ALTERNATIVOS DE SOLUCIÓN DE CONTROVERSIAS- En caso de inconformidad de {“EL USUARIO”} con cualquiera de los servicios objeto de estecontrato, o con los cargos y cantidades a cobrar, u otras cuestiones derivadas de los mismos; {“LAS PARTES”} pactan como medios alternativos de solución a talescontroversias, los siguientes, en ese orden de preferencia:
...
TRIGÉSIMA QUINTA. - La Comisión de Agua y Saneamiento del Municipio de Ajacuba, Hgo., está obligada a suministrar el servicio de agua potable hasta el ingreso a sudomicilio.

TRIGÉSIMA SEXTA. - LEGISLACIÓN Y JURISDICCIÓN- Para todo lo relativo a la interpretación, cumplimiento y ejecución del presente contrato, {“LAS PARTES”} se someten alas leyes aplicables y a los tribunales competentes en la ciudad de Pachuca de Soto, Estado de Hidalgo.

...
#Region "Tabla Recibos"
                ...
                Dim datosrecibo = ConsultaSql("select * from pagotros where serie='" & executeSQL("serie") & "' and recibo=" & Recibo & " And (CONCEPTO Like 'CONSUMO%' OR CONCEPTO LIKE 'REZAGO%')").ExecuteReader

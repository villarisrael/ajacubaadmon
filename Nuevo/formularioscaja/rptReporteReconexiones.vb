...
Public Class rptReporteReconexiones
...
#Region "Encabezado"
                ...
                ColPiePag1 = New PdfPCell(New Phrase("REPORTE DE INGRESOS CON RECONEXIONES", Font10N))
                ColPiePag1.Border = 0
                    ColPiePag1.HorizontalAlignment = PdfPCell.ALIGN_CENTER
                    'ColPiePag1.BackgroundColor = New iTextSharp.text.BaseColor(21, 76, 121)
...
#Region "Tabla Recibos"
                ...
                ColRecibo = New PdfPCell(New Phrase("UBICACION", Font7White))
                ColRecibo.Border = 0
                ...
                Dim ubicacion As String = obtenerCampo("select ubicacion from usuario where cuenta=" & Cuenta, "ubicacion")

                ColRecibo = New PdfPCell(New Phrase(ubicacion, Font10N))
                ColRecibo.Border = 1
                    ColRecibo.HorizontalAlignment = PdfPCell.ALIGN_CENTER
                    'ColPiePag1.BackgroundColor = New iTextSharp.text.BaseColor(21, 76, 121)
                ...
                Dim datosrecibo = ConsultaSql("select * from pagotros where serie='" & executeSQL("serie") & "' and recibo=" & Recibo & " And CONCEPTO Like 'Reconexi%'").ExecuteReader

                If datosrecibo.HasRows Then
                    ...
                    Try
                        ...
                        Dim colcantidad = New PdfPCell(New Phrase("CANT,", Font10N))
                        colcantidad.Border = 0
                        colcantidad.HorizontalAlignment = PdfPCell.ALIGN_CENTER
                        'ColPiePag1.BackgroundColor = New iTextSharp.text.BaseColor(21, 76, 121)
                        Tabledesgloze.AddCell(colcantidad)

                        Dim colconcepto = New PdfPCell(New Phrase("CONCEPTO", Font10N))
                        ...
                        Dim colimporte = New PdfPCell(New Phrase("IMPORTE", Font10N))
                        colimporte.Border = 0
                        colimporte.HorizontalAlignment = PdfPCell.ALIGN_RIGHT
                        'ColPiePag1.BackgroundColor = New iTextSharp.text.BaseColor(21, 76, 121)
                        Tabledesgloze.AddCell(colimporte)

                        Dim coliva = New PdfPCell(New Phrase("IVA", Font10N))
                        coliva.Border = 0
                        ...
                        While datosrecibo.Read
                            colcantidad = New PdfPCell(New Phrase(datosrecibo("cantidad"), Font10N))
                            colcantidad.Border = 0
                            colcantidad.HorizontalAlignment = PdfPCell.ALIGN_CENTER
                            'ColPiePag1.BackgroundColor = New iTextSharp.text.BaseColor(21, 76, 121)
                            Tabledesgloze.AddCell(colcantidad)

                            colconcepto = New PdfPCell(New Phrase(datosrecibo("concepto"), Font10N))
                            colconcepto.Border = 0
                            colconcepto.HorizontalAlignment = PdfPCell.ALIGN_LEFT
                            'ColPiePag1.BackgroundColor = New iTextSharp.text.BaseColor(21, 76, 121)
                            Tabledesgloze.AddCell(colconcepto)
                            ...
                            colimporte = New PdfPCell(New Phrase(datosrecibo("Importe"), Font10N))
                            colimporte.Border = 0
                            colimporte.HorizontalAlignment = PdfPCell.ALIGN_RIGHT
                            'ColPiePag1.BackgroundColor = New iTextSharp.text.BaseColor(21, 76, 121)
                            Tabledesgloze.AddCell(colimporte)

                            coliva = New PdfPCell(New Phrase(datosrecibo("MontoIVa"), Font10N))
                            coliva.Border = 0
                            coliva.HorizontalAlignment = PdfPCell.ALIGN_RIGHT
                            'ColPiePag1.BackgroundColor = New iTextSharp.text.BaseColor(21, 76, 121)
                            Tabledesgloze.AddCell(coliva)
